<template>
                ...
                <div class="ml-4 md:flex-1 md:flex md:flex-col md:justify-between lg:ml-0 lg:mt-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Take a look at our strenghts &amp; weaknesses, plus our opportunities and threats.
                        </p>
                    </div>
            ...
            <div class="flex md:h-full lg:flex-col">
                ...
                <div class="ml-4 md:flex-1 md:flex md:flex-col md:justify-between lg:ml-0 lg:mt-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            We've prepared some slides for you to better understand what we do.
                        </p>
                    </div>
                    <p class="mt-2 text-sm font-medium text-indigo-600 lg:mt-4">Learn more <span aria-hidden="true">&rarr;</span></p>
                </div>
            ...
            <div class="flex md:h-full lg:flex-col">
                ...
                <div class="ml-4 md:flex-1 md:flex md:flex-col md:justify-between lg:ml-0 lg:mt-4">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Take a guided tour of our entire ecosystem.
                        </p>
                    </div>
                    <p class="mt-2 text-sm font-medium text-indigo-600 lg:mt-4">Learn more <span aria-hidden="true">&rarr;</span></p>
                </div>
    ...
    <div class="bg-yellow-200 border-b-4 border-yellow-400">
        <div class="max-w-7xl mx-auto space-y-6 px-4 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-6 lg:px-8">
            <div class="flow-root">
                <a href="javascript://" class="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-100">
                    ...
                    <span class="ml-3">Watch Our App Demo</span>
                </a>
            </div>
            ...
            <div class="flow-root">
                <a href="javascript://" @click="openContact" class="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-100">
