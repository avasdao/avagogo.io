            ...
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8 xl:col-span-1">
                    ...
                    <div class="flex space-x-6">
                        ...
                        <a href="https://twitter.com/ShomariPrince" target="_blank" class="text-gray-400 hover:text-gray-300">
                        ...
                        <a href="https://github.com/modenero/avagogo" target="_blank" class="text-gray-400 hover:text-gray-300">
