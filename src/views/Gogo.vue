        ...
        <div class="bg-gray-50">
            <div class="relative">
                <div class="max-w-7xl mx-auto px-4 sm:px-6">
                    <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                        ...
                        <nav class="hidden md:flex space-x-10">
                            <div class="relative">
                                ...
                                <button
                                    type="button"
                                    class="text-gray-500 group bg-gray-50 rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500"
                                    aria-expanded="false"
                                >
                                    <span>Solutions</span>
                                    <!--
                  ...
                  -->
                                <div class="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2 hidden">
                                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                        <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                            <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                                <!-- Heroicon name: outline/chart-bar -->
                                                <svg class="flex-shrink-0 h-6 w-6 text-cyan-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                                    <path
                      ...
                      Item active: "text-gray-600", Item inactive: "text-gray-400"
                    -->
                                    <svg class="text-gray-400 ml-2 h-5 w-5 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                                    </svg>
                                </button>
                  ...
                  -->
                                    ...
                                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                        ...
                                        <div class="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                                            ...
                                            <div class="mt-5 text-sm">
                                                <a href="#" class="font-medium text-cyan-700 hover:text-cyan-600">View all posts <span aria-hidden="true">&rarr;</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
                            ...
                            <a href="#" class="whitespace-nowrap bg-cyan-600 border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex items-center justify-center text-base font-medium text-white hover:bg-cyan-700">
                                Sign up
                            </a>
                        </div>
                    </div>
          ...
          -->
                    ...
                    <div class="rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y-2 divide-gray-50">
                        <div class="pt-5 pb-6 px-5">
                            <div class="flex items-center justify-between">
                                <div>
                                    <img class="h-10 w-auto" :src="require('../assets/logo.png')" alt="Workflow" />
                                </div>
                                <div class="-mr-2">
                                    <button
                                        type="button"
                        ...
                        <div class="py-6 px-5 space-y-6">
                            ...
                            <div>
                                <a href="#" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-cyan-600 hover:bg-cyan-700">
                                    Sign up
                                </a>
                                <p class="mt-6 text-center text-base font-medium text-gray-500">
                                    Existing customer?
                                    <a href="#" class="text-cyan-600 hover:text-cyan-500">
                                        Sign in
                                    </a>
                                </p>
                            </div>
            ...
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h1 class="text-base font-semibold text-cyan-600 uppercase tracking-wide">
                        TOKENOMICS
                    </h1>
                    ...
                    <p class="max-w-xl mx-auto mt-5 text-xl text-gray-500">
                        ...
                        We're looking for team members to join the fastest growing community in DeFi.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="border-t border-gray-700 pt-8 space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-between xl:mt-0">
                    ...
                    <form class="sm:flex sm:max-w-md">
                        ...
                        <input
                            ...
                            autocomplete="email"
                            required
                            class="min-w-0 w-full bg-white border border-transparent py-2 px-4 placeholder-gray-500 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-white focus:border-white focus:placeholder-gray-400 sm:max-w-xs rounded-md"
                            placeholder="Enter your email"
                        />
                        <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                            <button
                                type="submit"
                                class="w-full bg-gray-700 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-white"
                            >
                                Subscribe
                            </button>
                        </div>
